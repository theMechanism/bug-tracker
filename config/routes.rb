BugTracker::Application.routes.draw do
  ...
  get "projects/:id/iframe_js" => "iframes#iframe_js", as: :project_iframe_js
  get "projects/:id/iframe/updated_bugs_table" => "iframes#updated_bugs_table", as: :project_iframe_bugs_table
